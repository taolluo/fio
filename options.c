...
struct fio_option fio_options[FIO_MAX_OPTS] = {
    ...
    {
            .name	= "square_wave_pulse_width",
            .lname	= "Time interval of square wave pulse",
            .type	= FIO_OPT_STR_VAL_TIME,
            .off1	= offsetof(struct thread_options, square_wave_pulse_width),
            .help	= "Time interval of square wave pulse",
            .is_seconds = 0,
            .is_time = 1,
            .category = FIO_OPT_C_GENERAL,
            .group	= FIO_OPT_G_RUNTIME,
